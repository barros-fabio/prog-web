...
<html>
    ...
    <body>
        <%
            ...
            request.getSession().setAttribute("aluno", request.getParameter("aluno"));
            System.out.println("idAluno "+request.getParameter("aluno"));    
        ...
        <div class="container">
          ...
          <!-- Barra de navegação estática-->
            ...
            <div class="jumbotron">
                <h3>Inserir novos dados do aluno: </h3>
                <br>
               
                <form name="formCadastroAluno" role="form" action="../AlterarAluno" method="POST" onsubmit="return checker()">
                    ...
                    <button type="submit" class="btn btn-default">Confirmar novos dados</button>                 
                </form>
            </div>
