 ...
 * @author fabio
 */
public class CidadesB extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        arquivo = new File("/home/fabio/NetBeansProjects/Exercicio1/src/java/cidades/CidadesB.txt");
        ...
        if(arquivo.isDirectory()){
            ...
            try {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servlet CidadesB</title>");    
